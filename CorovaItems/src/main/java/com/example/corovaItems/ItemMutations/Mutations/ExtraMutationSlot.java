...
public class ExtraMutationSlot implements Mutation {
    ...
    public List<String> getDescription(int level) {
        ...
        desc.add(ChatColor.GRAY + "Allows for an extra mutation slot on this item.");
        return desc;
    }

    @Override
    public MutationType getType() {
        return MutationType.EXTRA_MUTATION_SLOT;
    }
