...
public class DiamondScythe extends CorovaItems {
    ...
    public DiamondScythe() {
        super(
                ...
                "diamondscythe",
                CorovaCustomModelData.WEAPONS_DIAMOND_SCYTHE,
                attributes()
        );
    ...
    private static Map<Attribute, AttributeModifier> attributes() {
        JavaPlugin plugin = JavaPlugin.getProvidingPlugin(DiamondScythe.class);
        // Design rule: Attack Speed is fixed at double a sword's base (1.6 x 2 = 3.2)
        // Attack Damage target (matching the old hoe version): 6
        ...
        return Map.of(
                ...
                new AttributeModifier(new NamespacedKey(plugin, "diamondscythe_attack_speed"), -0.8, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.MAINHAND),
                Attribute.ATTACK_DAMAGE,
                new AttributeModifier(new NamespacedKey(plugin, "diamondscythe_attack_damage"), 5.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.MAINHAND)
        );
    }
    ...
    public ItemStack toItemStack() {
        ...
        if (meta != null) {
            NamespacedKey key = new NamespacedKey(JavaPlugin.getProvidingPlugin(DiamondScythe.class), "is_scythe");
