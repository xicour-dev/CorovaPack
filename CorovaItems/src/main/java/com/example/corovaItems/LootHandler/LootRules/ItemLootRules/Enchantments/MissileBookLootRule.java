...
/**
 * Loot rule for the Book of Missile enchantment book.
 */
public class MissileBookLootRule extends AbstractItemLootRule {

    public MissileBookLootRule() {
        super(
                "book_missile",   // Item ID
