...
/**
 * Loot rule for the Book of Night Vision enchantment book.
 */
public class NightVisionBookLootRule extends AbstractItemLootRule {

    public NightVisionBookLootRule() {
        super(
                "book_nightvision",   // Item ID
