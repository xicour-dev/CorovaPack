...
/**
 * Loot rule for the Book of Boomerang enchantment book.
 */
public class BoomerangBookLootRule extends AbstractItemLootRule {

    public BoomerangBookLootRule() {
        super(
                "book_boomerang",   // Item ID
                0.01,           // default 1% base chance
                0.005,          // default +0.5% per Looting level
                0.005           // default +0.5% per Luck level
        );

        registerMob("mutant_copper_golem_boss",          0.05,  0.03,  0.03,  true);
