...
/**
 * Loot rule for the Book of Freeze enchantment book.
 *
 ...
 */
public class FreezeBookLootRule extends AbstractItemLootRule {

    public FreezeBookLootRule() {
        super(
                "book_freeze_1",   // Item ID (must match ItemManager registration)
        ...
        registerMob("ice_wolf",          0.01,  0.005,  0.005,  true);  // DROPLIMITER: ON
        registerMob("ice_viking",          0.01,  0.005,  0.005,  true);  // DROPLIMITER: ON
