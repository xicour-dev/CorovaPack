...
/**
 * Loot rule for the Book of Snowstorm enchantment book.
 */
public class SnowStormBookLootRule extends AbstractItemLootRule {

    public SnowStormBookLootRule() {
        super(
                "book_snowstorm",   // Item ID
