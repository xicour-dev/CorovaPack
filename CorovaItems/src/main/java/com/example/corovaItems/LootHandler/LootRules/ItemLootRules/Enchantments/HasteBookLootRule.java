...
/**
 * Loot rule for the Book of Haste enchantment book.
 */
public class HasteBookLootRule extends AbstractItemLootRule {

    public HasteBookLootRule() {
        super(
                "book_haste",   // Item ID
        ...
        registerMob("inner_earth_cannibal_mob",          0.01,  0.005,  0.005,  true);
        registerMob("husked_digger_mob",          0.01,  0.005,  0.005,  true);
    }
}
