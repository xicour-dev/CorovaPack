...
/**
 * Loot rule for the Book of Ender Missile enchantment book.
 *
 ...
 */
public class EnderMissileBookLootRule extends AbstractItemLootRule {

    public EnderMissileBookLootRule() {
        super(
                "book_endermissile",   // Item ID (must match ItemManager registration)
        ...
        registerMob("ender_ghast_mob",          0.03,  0.03,  0.03,  true);  // DROPLIMITER: ON
