...
/**
 * Loot rule for the Book of Beam enchantment book.
 *
 ...
 */
public class BeamBookLootRule extends AbstractItemLootRule {

    public BeamBookLootRule() {
        super(
                "book_beam",   // Item ID (must match ItemManager registration)
        ...
        registerMob("corovacore_cyclops",          0.01,  0.005,  0.005,  true);  // DROPLIMITER: ON
