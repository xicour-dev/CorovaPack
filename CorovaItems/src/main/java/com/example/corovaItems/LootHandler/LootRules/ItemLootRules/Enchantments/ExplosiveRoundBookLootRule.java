...
/**
 * Loot rule for the Book of Explosive Round enchantment book.
 *
 ...
 */
public class ExplosiveRoundBookLootRule extends AbstractItemLootRule {

    public ExplosiveRoundBookLootRule() {
        super(
                "book_explosiveround",   // Item ID (must match ItemManager registration)
        ...
        registerMob("demolition_skeleton_mob",          0.03,  0.03,  0.03,  true);  // DROPLIMITER: ON
