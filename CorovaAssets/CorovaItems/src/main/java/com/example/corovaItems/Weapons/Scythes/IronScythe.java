...
public class IronScythe extends CorovaItems {
    ...
    public IronScythe() {
        super(
                ...
                "ironscythe",
                CorovaCustomModelData.WEAPONS_IRON_SCYTHE,
                attributes()
        );
    ...
    private static Map<Attribute, AttributeModifier> attributes() {
        ...
        return Map.of(
                ...
                new AttributeModifier(new NamespacedKey(plugin, "ironscythe_attack_speed"), -0.8, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.MAINHAND),
                Attribute.ATTACK_DAMAGE,
                new AttributeModifier(new NamespacedKey(plugin, "ironscythe_attack_damage"), 4.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.MAINHAND)
        );
    }
    ...
    public ItemStack toItemStack() {
        ...
        if (meta != null) {
            NamespacedKey key = new NamespacedKey(JavaPlugin.getProvidingPlugin(IronScythe.class), "is_scythe");
