...
/**
 * Loot rule for the Book of Divinum Trabem enchantment book.
 */
public class DivinumTrabemBookLootRule extends AbstractItemLootRule {

    public DivinumTrabemBookLootRule() {
        super(
                "book_divinum_trabem_1",   // Item ID
