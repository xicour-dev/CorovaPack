...
/**
 * Loot rule for the Book of Teleport enchantment book.
 *
 ...
 */
public class TeleportBookLootRule extends AbstractItemLootRule {

    public TeleportBookLootRule() {
        super(
                "book_teleport",   // Item ID (must match ItemManager registration)
        ...
        registerMob("ENDER_ARCHER",          0.06,  0.02,  0.02,  true);  // DROPLIMITER: ON
