 ...
 * Mana:       25
 *
 * Leather helmet dyed amethyst purple, SILENCE trim (amethyst material)
 * for broad visor coverage over the leather brow stripe.
 */
public class AmethystHelmet extends CorovaItems {
    ...
    private static Map<Attribute, AttributeModifier> buildAttributes() {
        ...
        attrs.put(Attribute.ARMOR,
                new AttributeModifier(
                        new NamespacedKey("corova", "amethysthelmet_armor"),
                        3.0,
                        AttributeModifier.Operation.ADD_NUMBER,
                        EquipmentSlotGroup.HEAD));
        attrs.put(Attribute.ARMOR_TOUGHNESS,
                new AttributeModifier(
                        new NamespacedKey("corova", "amethysthelmet_toughness"),
                        1.0,
                        AttributeModifier.Operation.ADD_NUMBER,
                        EquipmentSlotGroup.HEAD));
        return attrs;
