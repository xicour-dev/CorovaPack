...
/**
 * Loot rule for the Book of Payday enchantment book.
 */
public class PaydayBookLootRule extends AbstractItemLootRule {

    public PaydayBookLootRule() {
        super(
                "book_payday",   // Item ID
        ...
        registerMob("lost_merchant_boss",          0.06,  0.03,  0.03,  true);
