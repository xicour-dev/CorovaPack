...
/**
 * Loot rule for the Book of Wither enchantment book.
 *
 ...
 */
public class WitherBookLootRule extends AbstractItemLootRule {

    public WitherBookLootRule() {
        super(
                "book_wither",   // Item ID (must match ItemManager registration)
        ...
        registerMob("wither_ghast_mob",          0.01,  0.005,  0.005,  true);  // DROPLIMITER: ON
        registerMob("EVJ_Skeleton",          0.03,  0.01,  0.01,  true);  // DROPLIMITER: ON
