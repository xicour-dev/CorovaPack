...
/**
 * Loot rule for the Book of Poison enchantment book.
 *
 ...
 */
public class PoisonBookLootRule extends AbstractItemLootRule {

    public PoisonBookLootRule() {
        super(
                "book_poison",   // Item ID (must match ItemManager registration)
        ...
        registerMob("thepotent",          0.01,  0.005,  0.005,  true);  // DROPLIMITER: ON
        registerMob("EVJ_Spider",          0.04,  0.005,  0.005,  true);  // DROPLIMITER: ON
